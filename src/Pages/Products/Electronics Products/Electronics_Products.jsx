...
const Electronics_Products = () => {
  useEffect(() => {
    document.title = "Electronics Products - Inventory Management System";
  });
  ...
  const { data: AllProducts = [], isLoading, isSuccess } = useQuery({
    ...
    queryFn: async () => {
      ...
      const electronicsProducts = res.data.filter(product => product.category === "Electronics");
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <h1 className="text-3xl font-bold text-center text-blue-600 mb-8">Electronics Products</h1>
      <p className="text-center text-lg text-gray-500 mb-6">
        Here you can find a list of all our amazing electronics products.
      </p>
...
export default Electronics_Products;
