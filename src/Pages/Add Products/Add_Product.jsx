...
import { motion } from "framer-motion"; // For full-screen animation
...
const AddProduct = () => {
    ...
    const [showSuccessAnimation, setShowSuccessAnimation] = useState(false); // State to trigger animation
    ...
    return (
        <section className="min-h-screen py-16 px-6">
            ...
            {showSuccessAnimation && (
                <motion.div
                    className="fixed inset-0 bg-blue-500 flex justify-center items-center z-50"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ duration: 1 }}
                >
                    <h2 className="text-4xl text-white font-extrabold">Product Added Successfully!</h2>
                </motion.div>
            )}
